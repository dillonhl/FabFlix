package edu.uci.ics.dillonhl.service.idm.security;
...
public class Session {
    ...
    private final Token session_id;
    ...
    private Session(String email) {
        session_id = Token.generateToken();
        this.email = email;
     ...
     */
    private Session(String email, Token session_id, Timestamp timeCreated, Timestamp lastUsed, Timestamp exprTime) {
        this.email = email;
     ...
     */
    public static Session rebuildSession(String userName, Token session_id, Timestamp timeCreated, Timestamp lastUsed, Timestamp exprTime) {
        return new Session(userName, session_id, timeCreated, lastUsed, exprTime);
    }
